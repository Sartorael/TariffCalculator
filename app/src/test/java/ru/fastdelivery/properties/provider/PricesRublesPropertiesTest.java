...
class PricesRublesPropertiesTest {
  ...
  void testSetDepartureLongitudeStr() {
    ...
    assertEquals(
        BigDecimal.valueOf(Long.parseLong(departureLongitude)), properties.getDepartureLongitude());
  }
  ...
  void testSetDestinationLatitudeStr() {
    ...
    assertEquals(
        BigDecimal.valueOf(Long.parseLong(destinationLatitude)),
        properties.getDestinationLatitude());
  }
  ...
  void testSetDestinationLongitudeStr() {
    ...
    assertEquals(
        BigDecimal.valueOf(Long.parseLong(destinationLongitude)),
