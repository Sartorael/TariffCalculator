...
public class Beans {
    ...
    @Bean
    public TariffCalculateUseCaseVolume tariffCalculateUseCaseVolume(VolumePriceProvider volumePriceProvider){
    ...
    @Bean
    public TariffCalculateUseCaseLocation tariffCalculateUseCaseLocation(LocationPriceProvider locationPriceProvider){
