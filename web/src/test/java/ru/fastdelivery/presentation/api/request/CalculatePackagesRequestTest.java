...
public class CalculatePackagesRequestTest {
    ...
    void testRecordMethods() {
        ...
        testPackages.add(new CargoPackage(BigInteger.valueOf(405645), BigDecimal.valueOf(100),
                BigDecimal.valueOf(50), BigDecimal.valueOf(75)));
        String testCurrencyCode = "RUB";
        DepartureReq testDepartureReq = new DepartureReq(BigDecimal.valueOf(55.446008), BigDecimal.valueOf(65.339151));
        DestinationReq testDestinationReq = new DestinationReq(BigDecimal.valueOf(60.446008),
                BigDecimal.valueOf(70.339151));
        CalculatePackagesRequest calculateRequest = new CalculatePackagesRequest(testPackages, testCurrencyCode,
                testDepartureReq, testDestinationReq);
        ...
        CalculatePackagesRequest sameCalculateRequest = new CalculatePackagesRequest(testPackages, testCurrencyCode,
                testDepartureReq, testDestinationReq);
        assertThat(calculateRequest).isEqualTo(sameCalculateRequest);
        assertThat(calculateRequest.toString()).isEqualTo("CalculatePackagesRequest[packages=[CargoPackage" +
