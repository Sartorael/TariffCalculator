...
public class DestinationReqTest {
    ...
    void testRecordMethods() {
        ...
        DestinationReq differentDestination = new DestinationReq(new BigDecimal("11.123456"), new BigDecimal("22.654321"));
        ...
        assertThat(destination.toString()).isEqualTo("DestinationReq[latitude=55.446008, longitude=65.339151]");
    }
}
