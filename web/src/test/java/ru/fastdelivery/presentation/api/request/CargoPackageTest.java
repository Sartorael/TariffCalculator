...
public class CargoPackageTest {
    ...
    void testRecordMethods() {
        ...
        CargoPackage differentCargoPackage = new CargoPackage(BigInteger.valueOf(12345), BigDecimal.valueOf(100), BigDecimal.valueOf(50), BigDecimal.valueOf(75));
        assertThat(cargoPackage).isEqualTo(sameCargoPackage);
        assertThat(cargoPackage).isNotEqualTo(differentCargoPackage);
        assertThat(cargoPackage.toString()).isEqualTo("CargoPackage[weight=566745, length=560, width=100, height=200]");
    }
}
