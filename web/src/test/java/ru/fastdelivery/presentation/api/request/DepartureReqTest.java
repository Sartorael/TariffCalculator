...
public class DepartureReqTest {
    ...
    void testRecordMethods() {
        ...
        DepartureReq differentDeparture = new DepartureReq(new BigDecimal("11.123456"), new BigDecimal("22.654321"));
        assertThat(departure).isEqualTo(sameDeparture);
        assertThat(departure).isNotEqualTo(differentDeparture);
        assertThat(departure.toString()).isEqualTo("DepartureReq[latitude=55.446008, longitude=65.339151]");
    }
}
