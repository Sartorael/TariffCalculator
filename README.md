...
### Добавлено -
 В коде применялся объектно-ориентированный подход — каждый расчёт инкапсулировал в отдельный класс.
  Программа  обрабатывает некорректные данные в запросах.
  Используется логирование для сохранения информации об ошибках и результатах расчётов.
  Длина отдельного метода не  превышает 40 строк.
  Покрытие тестами нового кода более 70%.
  Стиль кода соответствует правилам Google Java Style Guide.
- 
- 